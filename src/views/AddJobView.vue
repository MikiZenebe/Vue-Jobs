    ...
    <div class="container m-auto max-w-2xl py-24">
      ...
      >
        <form @submit.prevent="handleSubmit">
          ...
          <div class="mb-4">
            <label class="block text-gray-400 font-bold mb-2"
          ...
          <div class="mb-4">
            <label for="description" class="block text-gray-400 font-bold mb-2"
              >Description</label
            >
            <textarea
              id="description"
          ...
          <div class="mb-4">
            <label for="company" class="block text-gray-400 font-bold mb-2"
              >Company Name</label
            >
            <input
              type="text"
